...
for IC in glucIC_files:
    #Regular
    subprocess.call(["./run_file", "0.0", "1.0", "./BGnetworks/Regular_APNN.nt", IC, "./OutputRanges/Regular_"+str(IC[-7:-4])+".csv"])
    #Split structure
    subprocess.call(["./run_file", "0.0", "1.0", "./BGnetworks/SplitLayer_APNN.nt", IC, "./OutputRanges/SplitLayer_"+str(IC[-7:-4])+".csv"])
    #weight constrained
    subprocess.call(["./run_file", "0.0", "1.0", "./BGnetworks/WeightCons_APNN.nt", IC, "./OutputRanges/WeightCons_"+str(IC[-7:-4])+".csv"])
